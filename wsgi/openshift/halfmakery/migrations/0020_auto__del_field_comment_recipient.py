...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comment.recipient'
        db.delete_column('halfmakery_comment', 'recipient_id')
    ...
    def backwards(self, orm):
        # Adding field 'Comment.recipient'
        db.add_column('halfmakery_comment', 'recipient',
    ...
    models = {
        ...
        'halfmakery.comment': {
            ...
            'recipient': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'user'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
