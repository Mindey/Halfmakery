...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.satoshis'
        db.add_column('halfmakery_comment', 'satoshis',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.satoshis'
        db.delete_column('halfmakery_comment', 'satoshis')
    ...
    models = {
        ...
        'halfmakery.comment': {
            ...
            'satoshis': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
