...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field recipient on 'Comment'
        db.delete_table(db.shorten_name('halfmakery_comment_recipient'))

        # Adding M2M table for field recipients on 'Comment'
        m2m_table_name = db.shorten_name('halfmakery_comment_recipients')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comment', models.ForeignKey(orm['halfmakery.comment'], null=False)),
    ...
    def backwards(self, orm):
        # Adding M2M table for field recipient on 'Comment'
        m2m_table_name = db.shorten_name('halfmakery_comment_recipient')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comment', models.ForeignKey(orm['halfmakery.comment'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ...
        # Removing M2M table for field recipients on 'Comment'
        db.delete_table(db.shorten_name('halfmakery_comment_recipients'))
