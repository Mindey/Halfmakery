...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Approach', fields ['name']
        db.delete_unique('halfmakery_approach', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Approach', fields ['name']
        db.create_unique('halfmakery_approach', ['name'])
