...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Idea.currency'
        db.add_column('halfmakery_idea', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['halfmakery.Currency']),
                      keep_default=False)

        # Adding field 'Idea.txid'
        db.add_column('halfmakery_idea', 'txid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Idea.user'
        db.add_column('halfmakery_idea', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Idea.satoshis'
        db.add_column('halfmakery_idea', 'satoshis',
                      self.gf('django.db.models.fields.BigIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Idea.currency'
        db.delete_column('halfmakery_idea', 'currency_id')

        # Deleting field 'Idea.txid'
        db.delete_column('halfmakery_idea', 'txid')

        # Deleting field 'Idea.user'
        db.delete_column('halfmakery_idea', 'user_id')

        # Deleting field 'Idea.satoshis'
        db.delete_column('halfmakery_idea', 'satoshis')
