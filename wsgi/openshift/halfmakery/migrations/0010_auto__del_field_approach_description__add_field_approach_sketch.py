...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Approach.description'
        db.delete_column('halfmakery_approach', 'description')

        # Adding field 'Approach.sketch'
        db.add_column('halfmakery_approach', 'sketch',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Approach.description'
        db.add_column('halfmakery_approach', 'description',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)

        # Deleting field 'Approach.sketch'
        db.delete_column('halfmakery_approach', 'sketch')
