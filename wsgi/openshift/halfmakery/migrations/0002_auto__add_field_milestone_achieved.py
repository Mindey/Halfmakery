...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Milestone.achieved'
        db.add_column('halfmakery_milestone', 'achieved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Milestone.achieved'
        db.delete_column('halfmakery_milestone', 'achieved')
