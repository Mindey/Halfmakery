...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Idea.satoshis'
        raise RuntimeError("Cannot reverse this migration. 'Idea.satoshis' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Idea.satoshis'
