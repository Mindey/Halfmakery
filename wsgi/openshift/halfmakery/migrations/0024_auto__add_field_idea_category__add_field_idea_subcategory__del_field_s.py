...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('halfmakery_subcategory', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['halfmakery.Category']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('halfmakery_subcategory', 'idea',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['halfmakery.Idea'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Subcategory.category'
        db.delete_column('halfmakery_subcategory', 'category_id')

        # Adding field 'Category.subcategory'
        db.add_column('halfmakery_category', 'subcategory',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['halfmakery.Subcategory'], null=True, blank=True),
                      keep_default=False)
