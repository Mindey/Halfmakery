...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subcategory.idea'
        db.alter_column('halfmakery_subcategory', 'idea_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['halfmakery.Idea'], null=True))

        # Changing field 'Category.subcategory'
        db.alter_column('halfmakery_category', 'subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['halfmakery.Subcategory'], null=True))

    def backwards(self, orm):

        # Changing field 'Subcategory.idea'
        db.alter_column('halfmakery_subcategory', 'idea_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['halfmakery.Idea']))

        # Changing field 'Category.subcategory'
        db.alter_column('halfmakery_category', 'subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['halfmakery.Subcategory']))
    ...
    models = {
        ...
        'halfmakery.category': {
            ...
            'subcategory': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['halfmakery.Subcategory']", 'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'halfmakery.comment': {
            ...
            'recipients': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'user'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            'satoshis': ('django.db.models.fields.BigIntegerField', [], {}),
        ...
        'halfmakery.subcategory': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idea': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['halfmakery.Idea']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'halfmakery.task': {
