...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('halfmakery_reference')

        # Adding field 'Idea.reference'
        db.add_column('halfmakery_idea', 'reference',
                      self.gf('django.db.models.fields.URLField')(default='http://www.halfbakery.com', max_length=4096),
                      keep_default=False)


        # Changing field 'Idea.subcategory'
        db.alter_column('halfmakery_idea', 'subcategory_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['halfmakery.Subcategory']))

    def backwards(self, orm):
        # Adding model 'Reference'
        db.create_table('halfmakery_reference', (
        ...
        db.send_create_signal('halfmakery', ['Reference'])

        # Deleting field 'Idea.reference'
        db.delete_column('halfmakery_idea', 'reference')


        # Changing field 'Idea.subcategory'
        db.alter_column('halfmakery_idea', 'subcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['halfmakery.Subcategory']))
    ...
    models = {
        ...
        'halfmakery.idea': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'reference': ('django.db.models.fields.URLField', [], {'max_length': '4096'}),
            'subcategory': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': "orm['halfmakery.Subcategory']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'halfmakery.link': {
